    ...
    public function formatHtml($roomImages): string
    {
        ...
        if ($roomImages != null) {
            ...
            foreach ($roomImages as $roomImage) {
                ...
                <img src="/room/image/' . $roomImage->getName() . '">
            </div>';
            }
            ...
            $html .= '<div class="slide">
                <img src="/room/image/room_noimage.jpg">
            </div>';
        }
        return $html;
    }
        ...
        if ($roomImages != null) {
            ...
            foreach ($roomImages as $roomImage) {
                ...
                $html .= '<div class="img-wrap image-thumbnail" id="image-thumbnail-' . $roomImage->getId() . '">
                            ...
                            <img data-image-id="' . $roomImage->getId() . '" class="room_images '.$imageNotDefaultClass.'" src="/room/image/thumb' . $roomImage->getName() . '">
                        </div>';
            }
        } else {
            $html .= '<h5>No images found</h5>';
