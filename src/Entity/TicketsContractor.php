 ...
 * TicketsContractor
 *
 * @ORM\Table(name="tickets_contractor", indexes={@ORM\Index(name="tickets_contractor_contractor_idx", columns={"contractor"}), @ORM\Index(name="tickets_contractor_ticket_idx", columns={"ticket"})})
 * @ORM\Entity
 */
